...
func InitOptionMap() {
	...
	common.OptionMap["WechatPayKey"] = setting.WechatPayKey
	...
	common.OptionMap["ImageSizePrice"] = ratio_setting.ImageSizePrice2JSONString()
	common.OptionMap["AudioRatio"] = ratio_setting.AudioRatio2JSONString()
	common.OptionMap["AudioCompletionRatio"] = ratio_setting.AudioCompletionRatio2JSONString()
	common.OptionMap["LongContextModelRatio"] = ratio_setting.LongContextModelRatio2JSONString()
	common.OptionMap["LongContextCompletionRatio"] = ratio_setting.LongContextCompletionRatio2JSONString()
	common.OptionMap["LongContextCacheRatio"] = ratio_setting.LongContextCacheRatio2JSONString()
	common.OptionMap["LongContextCreateCacheRatio"] = ratio_setting.LongContextCreateCacheRatio2JSONString()
	common.OptionMap["LongContextThreshold"] = strconv.Itoa(ratio_setting.GetLongContextThreshold())
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "LongContextModelRatio":
		err = ratio_setting.UpdateLongContextModelRatioByJSONString(value)
	case "LongContextCompletionRatio":
		err = ratio_setting.UpdateLongContextCompletionRatioByJSONString(value)
	case "LongContextCacheRatio":
		err = ratio_setting.UpdateLongContextCacheRatioByJSONString(value)
	case "LongContextCreateCacheRatio":
		err = ratio_setting.UpdateLongContextCreateCacheRatioByJSONString(value)
	case "LongContextThreshold":
		threshold, parseErr := strconv.Atoi(value)
		if parseErr != nil {
			err = parseErr
		} else {
			ratio_setting.SetLongContextThreshold(threshold)
		}
	case "TopUpLink":
