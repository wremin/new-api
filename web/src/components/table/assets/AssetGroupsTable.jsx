...
const renderGroupTypeTag = (groupType, t) => (
  <Tag color={groupType ? 'violet' : 'grey'} shape='circle'>
    {groupType || t('未知')}
  </Tag>
);
      ...
      [
        ...
        caps.regions
          ...
          : {
              ...
              dataIndex: 'groupType',
              key: 'groupType',
              render: (groupType) => renderGroupTypeTag(groupType, t),
            },
        {
          title: t('素材数量'),
          dataIndex: '_count',
